...
devolverString("Hello hello, Como estas????????");
...
agregarSimboloExclamacion("Hello MUNDO");
...
combinarNombres("Yoaquino", "Yoaquino");
...
function esVocal(letra) {
  ...
  /*  ||   or  */
  if (letra.length>1) {
    document.write ("datos en correcto, pasaste de letras");
  } else
   {
    switch (letra) {
      case "a":
